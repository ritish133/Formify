  ...
  return (
    ...
    className='border p-5 md:w-[600px] rounded-lg'
     ...
     >
      ...
      {!enabledSignIn?
       <button  className='btn btn-primary bg-black hover:bg-black hover:border-black border-black text-white'>Submit</button>:
      isSignedIn?
    <button  className='btn btn-primary btn-primary bg-black hover:bg-black hover:border-black border-black text-white'>Submit</button>:
    <Button>
